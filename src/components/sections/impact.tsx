...
const impactData = [
  ...
  { number: '₹10 Cr+', text: 'Secured through Credit Guarantee Scheme in FY 2024–25' },
...
export function Impact() {
  return (
    <Section id="impact" className="bg-gradient-to-r from-primary to-blue-800 text-white">
      <AnimateOnScroll>
        <SectionTitle className="text-white after:bg-accent">Our Impact</SectionTitle>
        <SectionDescription className="text-gray-200">
